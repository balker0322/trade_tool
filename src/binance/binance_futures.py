...
from .mod_func import logger, ord_suffix, retry, notify

from abc import ABC, abstractmethod


class BinanceFutures(ABC):
    # Account
    account = ''
    # Pair
    pair = 'BTCUSDT'
    ...
    def __new_order(self, ord_id, side, ord_qty, limit=0, stop=0, post_only=False, reduce_only=False, trailing_stop=0, activationPrice=0):
        ...
        # self._new_order(ord_id, side, ord_qty, limit, stop, post_only, reduce_only, trailing_stop, activationPrice)
        # return
